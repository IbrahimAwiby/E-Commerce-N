      ...
      >
        {!user ? (
          ...
          <View className="items-center w-full">
            ...
            <Text className="text-secondary text-base mb-8 text-center w-3/4 px-8">
              Login to view your profile, orders, and addressws.
            </Text>
            <TouchableOpacity
              onPress={() => router.push("/sign-in")}
              className="bg-primary w-3/5 px-4 py-3 rounded-full items-center shadow-lg"
            >
